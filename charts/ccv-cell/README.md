...
| aggregator.image.tag | string | `"v4.4.4"` | Image tag. Mutually exclusive with `digest`.    All tags in the default repository are immutable. |
...
| verifier.image.tag | string | `"v4.4.4"` | Image tag. Mutually exclusive with `digest`.    All tags in the default repository are immutable. |

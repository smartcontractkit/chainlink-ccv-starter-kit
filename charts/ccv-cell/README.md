...
| aggregator.image.tag | string | `"v0.12.0"` | Image tag. Mutually exclusive with `digest`.    All tags in the default repository are immutable. |
...
| verifier.image.tag | string | `"v0.12.0"` | Image tag. Mutually exclusive with `digest`.    All tags in the default repository are immutable. |
